...
const HomeScreen = () => {
  ...
  const updateTodo = (id: number) => {
    ...
    if (todoToEdit) {
      ...
      setEditingTodoId(id); // start edit mode
    }
  };
    ...
    <View style={style.container}>
      ...
      <View style={style.header}>
        ...
        <TouchableOpacity
          onPress={() => {
            router.push(
              "/features/home/todo/presentation/pages/settings_screen"
            );
          }}
        >
        ...
        <Text style={style.appbarTitle}>Home</Text>

        {/* Profile Icon */}
        <TouchableOpacity
          onPress={() => {
            router.push(
              "/features/home/todo/presentation/pages/profile_screen"
            );
          }}
        >
          <Image
      ...
      <KeyboardAvoidingView style={style.footer}>
        ...
        <TouchableOpacity style={style.addButton} onPress={addTodo}>
          <Ionicons
            name={editingTodoId !== null ? "checkmark" : "add"}
            size={34}
            color={"#fff"}
          />
        </TouchableOpacity>
